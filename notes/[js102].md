...
```
## 剩餘運算子 Rest Operator
+ 剩餘運算子用來將不確定數量的參數集合起來並存成一個**陣列**
+ 用法：與展開運算子相同，都是使用三個點 ... (three dots) 來標示
+ 又稱「其餘參數」Rest Parameters
### 使用案例：
+ 與解構搭配使用
``` js
